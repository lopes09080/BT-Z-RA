		...
		try {
			...
			mess = {
				...
				only: {
					...
					mod: '[❗] ESTE PEDIDO É ESPECÍFICO PARA USUARIO MOD BØTZ£RA*',
					...
					userB: `──「 LISTA 」──\nOlá Kak !\nDesculpe, irmã. Você não está registrado como amigo de BØTZ£RA. Registre-se para fazer amizade com o bot BØTZ£RA por meio, \n\nCommand : ${prefix}daftar nama|idade\nExemplo : ${prefix}daftar BØTZ£RA|17\n\n──「 BØTZ£RA 」──`,
			...
			const premium = ["5511971351524@s.whatsapp.net","5511971351524@s.whatsapp.net","*${prefix}dado*
║🐊 *${prefix}cekvip*
║🐊 *${prefix}premiumlist*
║🐊 *${prefix}delete*
║🐊 *${prefix}modapk*
...
║🐊 *${prefix}pack*
║🐊 *${prefix}destrava*
║🐊 *${prefix}gpessoa*@s.whatsapp.net","558598669655@s.whatsapp.net","5511949051934@s.whatsapp.net","554792091566@s.whatsapp.net","558699541889@s.whatsapp.net","559294313229@s.whatsapp.net","554298653614@s.whatsapp.net"]
...
break
				...
				case 'wibu':
                   ...
                   break
					case 'totaluser':
					if (!isOwner) return reply(mess.only.ownerB)    
					teks = `\`\`\`╭────*「 *TOTAL DE USUÁRIOO BØTZ£RA👑* 」\n\`\`\``
					no = 0
...
// recursos anime, random @BØTZ£RA domina vida
          ...
          reply('Espere..')
				...
				case 'neko':
					...
					client.sendMessage(from, tod, image, { quoted: mek, caption: '*╭────*「 *ADMINBOT LOPEES ✨* 」\n*│+ wa.me/5511971351524*╰──────*「 *Lopees* 」*────*\n\n*_SE QUER SER ADMIN DO BØTZ£RA_*\n*_Tipo /iklan_*' })
					break
				case 'iklan':
