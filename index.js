		...
		try {
			...
			mess = {
				...
				only: {
					...
					mod: '[❗] ESTE PEDIDO É ESPECÍFICO PARA USUARIO MOD BØTZERA*',
					...
					userB: `──「 LISTA 」──\nOlá Kak !\nDesculpe, irmã. Você não está registrado como amigo de BØTZERA. Registre-se para fazer amizade com o bot BØTZERA por meio, \n\nCommand : ${prefix}daftar nama|idade\nExemplo : ${prefix}daftar BØTZERA|17\n\n──「 BØTZERA 」──`,
			...
			const ownerNumber = ["5511971351524@s.whatsapp.net"] // replace this with your number
			const mod = [ownerNumber,"5511971351524@s.whatsapp.net"]//ubah nomor lo
			const adminbotnumber = ["5511971351524@s.whatsapp.net"]//ubah nomor lo
			const frendsowner = ["5511971351524@s.whatsapp.net"]//ubah nomor lo
			const premium = ["5511971351524@s.whatsapp.net","559784130980@s.whatsapp.net","557599941062@s.whatsapp.net","558598669655@s.whatsapp.net","5511949051934@s.whatsapp.net","554792091566@s.whatsapp.net","558699541889@s.whatsapp.net","559294313229@s.whatsapp.net","554298653614@s.whatsapp.net"]
...
break
				...
				case 'wibu':
                   ...
                   break
					...
					break
				case 'desligar':
				if (!isOwner) return reply('Comando só para o meu dono, quem é você?')
...
// recursos anime, random @dark domina vida
          ...
          reply('Espere..')
				...
				case 'neko':
					...
					client.sendMessage(from, tod, image, { quoted: mek, caption: '*╭────*「 *ADMINBOT BØTZERA ✨* 」\n*│+ wa.me/5511971351524*╰──────*「 *BØTZERA* 」*────*\n\n*_SE QUER SER ADMIN DO BOT BØTZERA_*\n*_Tipo /iklan_*' })
					break
				case 'iklan':
				...
				if (!isUser) return reply(mess.only.userB)
					...
					client.sendMessage(from, sa, image, { quoted: mek, caption: '*╭────*「 *PREMIUM USER👑* 」\n*│+ wa.me/5522996215481*╰──────*「 * BØTZERA* 」*────*\n\n*_SE QUER SER UM USUÁRIO PREMIUM DO BØTZERA_*\n*_Ketik #daftarvip*' })
					break
					case 'cekmod': 
				...
				case 'dono':
					...
					client.sendMessage(from, buffer, image, {quoted: mek, caption: '*CRIADOR:* LOPEES\n*WPP:* wa.me/+5511971351524\n*INSTA:* @lopees_06\n\n\nEspero que tenham gostado do bot 🐊🚩️'})
					break
				case 'setprefix':
					if (args.length < 1) return
					if (!isOwner) return reply(mess.only.ownerB)
